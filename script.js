...
//DOM configuration and table creation
let head = document.createElement('h1');
head.setAttribute('id','title');
head.innerHTML='STUDENT';
document.body.append(head);

let description = document.createElement('p');
description.setAttribute('id','description');
description.innerHTML='Student details are listed below';
...
button_cont.setAttribute('class','buttonArea');
container.append(button_cont);

let table_area = document.createElement('table');
table_area.setAttribute('class','table table-border');
table_area.setAttribute('id','table');
container.append(table_area);

let table_head = document.createElement('thead');
table_head.setAttribute('id','head_data')
table_area.append(table_head);

let head1 = document.createElement('th');
head1.innerHTML='ID';
table_head.append(head1);

let head2 = document.createElement('th');
head2.innerHTML='NAME';
table_head.append(head2);

let head3 = document.createElement('th');
head3.innerHTML='EMAIL';
table_head.append(head3);

let table_body = document.createElement('tbody');
table_body.setAttribute('id','content_td');
table_area.append(table_body);
...
button_cont.append(firstButton);
...
previousButton.innerHTML = 'PRE';
button_cont.append(previousButton);

previousButton.addEventListener('click',()=>{
  table_body.innerHTML="";
  let i = clicked_button;
  i--;
  clicked_button=i;
  let page = 10;
  if(i>0){
...
lastButton.setAttribute('class','func_but');
button_cont.append(lastButton);
